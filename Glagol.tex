...
\newcommand{\HL}[1]{ \color{red}\underline{#1} }
...
\begin{tabular}{| l | p{4cm} | p{4cm}|}
	...
	\hline
	1 & \greek{paideus\HL{w}}	  & я воспита\HL{ю} \\ \hline
	2 & \greek{paideus\HL{eis}}	  & ты воспита\HL{ешь} \\ \hline
	3 & \greek{paideuei} 		  & он воспитает \\ \hline
	\multicolumn{3}{| c |}{Pluralis} \\ \hline
	1 & \greek{paideusom\HL{en}}  & мы воспита\HL{ем} \\ \hline
	2 & \greek{paideuse\HL{te}}	  & вы воспитае\HL{те} \\ \hline
...
\begin{tabular}{| l | p{4cm} | p{4cm}| l | l | l | l |} 
	...
	\cline{1-3}
	\cline{5-7}
	1 & orn\HL{o} & я украша\HL{ю}  & \, & ты & orn\HL{a}  & украш\HL{ай} \\
	\cline{5-7}
	\cline{1-3}
	2 & orna\HL{s} & ты украша\HL{ешь}  & \, & вы & orna\HL{te} & украшай\HL{те} \\ 
	\cline{5-7} 
	\cline{1-3}
	3 & orna\HL{t} & он украшае\HL{т} \\ 
	\cline{1-3}
	%Pluralis%
	\multicolumn{3}{| c |}{Pluralis} \\
	\cline{1-3}
	1 & orna\HL{mus} & мы украша\HL{ем} \\
	\cline{1-3}
	2 & orna\HL{tis} & вы украшае\HL{те} \\
	\cline{1-3}
	3 & ornan\HL{t} & они украшаю\HL{т}\\ 
	\cline{1-3}
\end{tabular}
...
%%%%%Here is experimental part of working with graphical package%%%%
\begin{tikzpicture}
